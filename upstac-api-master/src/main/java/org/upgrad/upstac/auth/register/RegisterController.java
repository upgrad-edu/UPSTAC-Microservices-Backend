...
public class RegisterController {
    ...
    @RequestMapping(value = "/auth/newuser", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/auth/newdoctor", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/auth/newtester", method = RequestMethod.POST)
